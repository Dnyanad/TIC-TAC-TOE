...
cell1cord = (0 + 25,0 + 25)
cell2cord = (0 + 25,200 + 25)
cell3cord = (0 + 25,400 + 25)
cell4cord = (200 + 25,0 + 25)
cell5cord = (200 + 25,200 + 25)
cell6cord = (200 + 25,400 + 25)
cell7cord = (400 + 25,0 + 25)
cell8cord = (400 + 25,200 + 25)
cell9cord = (400 + 25,400 + 25)
...
def pygame_MouseButtonClick(a):
    ...
    if x >= 200 and x <= 400 and y >= 200 and y <= 400:
        cell5 = True
        if a == 0:
            win.blit(ximage, cell5cord)
            write(0, 610, 'PLAYER 1', (0,0,0))
            grid[1][1] = 'x'
            pygame.display.update()
            a = 1
        else:
            win.blit(oimage, cell5cord)
            grid[1][1] = 'o'
            write(0, 610, 'PLAYER 2', (0,0,0))
            pygame.display.update()
            a = 0
    ...
    if x >= 400 and x <= 600 and y >= 200 and y <= 400:
        cell8 = True
        if a == 0:
            win.blit(ximage, cell8cord)
            write(0, 610, 'PLAYER 1', (0,0,0))
            grid[2][1] = 'x'
            pygame.display.update()
            a = 1
        else:
            win.blit(oimage, cell8cord)
            grid[2][1] = 'o'
            write(0, 610, 'PLAYER 2', (0,0,0))
            pygame.display.update()
            a = 0
    ...
    if x >= 200 and x <= 400 and y >= 400 and y <= 600:
        cell6 = True
        if a == 0:
            win.blit(ximage, cell6cord)
            write(0, 610, 'PLAYER 1', (0,0,0))
            grid[1][2] = 'x'
            pygame.display.update()
            a = 1
        else:
            win.blit(oimage, cell6cord)
            grid[1][2] = 'o'
            write(0, 610, 'PLAYER 2', (0,0,0))
            pygame.display.update()
            a = 0
